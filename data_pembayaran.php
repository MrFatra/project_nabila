...
<body>
	...
	<br />
	<a href="tambah_data_pembayaran.php">+ TAMBAH DATA</a>
	<br />
	<br />
	<table border="1">
		<tr>
		...
		?>
			<tr>
				...
				<td>
					<!-- Ganti echo nya klo gabisa -->
					<a href="edit_data_pembayaran.php?id=<?php echo $d['id']; ?>">EDIT</a>
					<a href="hapus_data_pembayaran.php?id=<?php echo $d['id']; ?>">HAPUS</a>
				</td>
			</tr>
		<?php
		}
